    ...
    try:
        ...
        for kol in kolom_angka:
            if kol in df_all.columns:
                # Konversi data Excel ke string untuk pembersihan karakter non-numerik jika ada
...
with st.container():
    ...
    with col_sim1:
        target_2026 = st.number_input("**Target Pertumbuhan Ekonomi (%):**", value=5.0, step=0.1)
